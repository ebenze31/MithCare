<div class="row">
    ...
    <div id="div_datetime_edit" class="form-group {{ $errors->has('date_time') ? 'has-error' : ''}} col-md-12 col-12">
    ...
    <div  id="div_date_edit" class="form-group {{ $errors->has('date') ? 'has-error' : ''}} col-md-12 col-12 ">
