                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Group Id</th><th>Group Name</th><th>Picture Url</th><th>Owner</th><th>Partner Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($group_line as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->group_id }}</td><td>{{ $item->group_name }}</td><td>{{ $item->picture_url }}</td><td>{{ $item->owner }}</td><td>{{ $item->partner_id }}</td>
                                        <td>
