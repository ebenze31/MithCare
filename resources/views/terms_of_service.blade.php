...
@section('content')
    <div class="container bg-white main-shadow">
        <div class="row" style="margin: 15px ;">
            <div class="col-md-12">
                <br><br>
                <h3 style="margin: 5px;">ข้อกำหนดและเงื่อนไขการใช้บริการบน เว็บไซต์ MithCare.com</h3>
                <hr>

                <h5 style="text-decoration: underline; padding: 10px;">1. การยอมรับในข้อกำหนดและเงื่อนไขการใช้บริการ MithCare.com</h5>
                <p style="font-size: 16px; text-indent:30px;">บริษัท ณินทร์ เอเชีย จำกัด (“บริษัท”) ให้บริการเว็บไซต์ MithCare.com หรือแอปพลิเคชันอื่นใดที่บริษัทให้บริการ หรือแอปพลิเคชันชื่ออื่นที่บริษัทเป็นผู้พัฒนา (“บริการ”) แก่สมาชิก (“ท่าน”) ภายใต้ข้อกำหนดและเงื่อนไขต่างๆ ที่บริษัทสามารถปรับปรุงให้ทันสมัยได้ตลอดเวลาโดยไม่ต้องบอกกล่าว ท่านต้องปฏิบัติตามข้อกำหนดและเงื่อนไขการใช้บริการอย่างเคร่งครัดตลอดเวลา
                </p>
