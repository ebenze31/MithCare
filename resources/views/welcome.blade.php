...
<body id="section_1">
    ...
    <nav class="navbar navbar-expand-lg shadow-lg" style="background-color: #f0f8ff;">
        <div class="container">
            <a class="navbar-brand" style="margin: 10px 0;">
                <img width="100"  src="{{ url('img/logo_mithcare/x-icon.png') }}" class="logo img-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-3">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link custom-btn custom-border-btn btn" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                        ...
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="img/logo_mithcare/different-people-doing-volunteer-work.jpg" class="carousel-image img-fluid" alt="...">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 text-center mx-auto">
                        <h2 class="mb-5">Welcome to Mithcare</h2>
                    </div>
